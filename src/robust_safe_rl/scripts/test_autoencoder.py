"""Re-test a trained checkpoint on freshly collected ID and strict-OOD data.

Loads a checkpoint by numeric index, regenerates independent ID/OOD rollouts,
and reports reconstruction-error summaries and detection rates under both the
checkpoint's stored thresholds and fresh test-set thresholds. Useful for
checking that detection performance holds on unseen episodes.
"""
